package com.mcalineyt.maven_test_version;
import java.io.*;
import java.net.*;
...
{
  //static constants
  //Tom root is the current directory
  static final File WEB_ROOT = new File(".");
  static final String DEFAULT_FILE = "index.html";
  static final int PORT = 10000; //default port
  ...
  /**
   * main method creates a new Tom instance for each
  ...
  public static void main(String[] args)
  {
    ...
    int port=Integer.parseInt(args[count]);
    ...
    try
    {
      ...
      {
        Tom server = new Tom(
          serverConnect.accept()); //instantiate Tom
        if (verbose)
        {
